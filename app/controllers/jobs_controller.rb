class JobsController < AdministrativeController
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:receive_date, :section_id, :contact_person, :responsible_person, :total, :work_description, :jce_number, :targeted_amount, :quotation_reference)
    end
end
